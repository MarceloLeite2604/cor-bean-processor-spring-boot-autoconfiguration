...
import com.figtreelake.corbeanprocessor.autoconfigure.util.test.dummy.DummyClassA;
import com.figtreelake.corbeanprocessor.autoconfigure.util.test.dummy.DummyClassB;
import com.figtreelake.corbeanprocessor.autoconfigure.util.test.dummy.DummyClassC;
import com.figtreelake.corbeanprocessor.autoconfigure.util.test.dummy.DummyClassD;
import com.figtreelake.corbeanprocessor.autoconfigure.util.test.dummy.DummyClassE;
import com.figtreelake.corbeanprocessor.autoconfigure.util.test.dummy.DummyClassF;
